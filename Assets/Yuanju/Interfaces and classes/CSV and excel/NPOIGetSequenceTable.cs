...
/// <summary>
/// the scripts to extract the data from the new version excel file, and save the values in a list of data table
/// </summary>
public class NPOIGetSequenceTable : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            OperableComponentNames.Add(column.ColumnName); //add the name of actuators to OperableComponentNames list
        }
