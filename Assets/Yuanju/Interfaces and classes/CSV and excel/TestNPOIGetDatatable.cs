...
public class TestNPOIGetDatatable : MonoBehaviour
{
    ...
    ////////////    {
    ////////////        if (NPOIGetInitialFinalSettings.FinalSettings[i].TableName == "start the generator" /*PanelManager.listToggleText[2]*/)
    ////////////        {
    ////////////            finalSettingdt = NPOIGetInitialFinalSettings.FinalSettings[i];
    ////////////        }
    ////////////    }
