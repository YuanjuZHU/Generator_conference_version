...
public class Boiler : MonoBehaviour, IGeneratorComponent
{
    ...
    public void Initialize()
    {
        ...
        Debug.Log("ComputeDistanceWaterAndRod(ZeroWaterLevel, DetectorLong):" + ComputeDistanceWaterAndRod(ZeroWaterLevel, DetectorLong));
        ...
        Debug.Log("ComputeDistanceWaterAndRod(ZeroWaterLevel, DetectorShort): " + ComputeDistanceWaterAndRod(ZeroWaterLevel, DetectorShort));
