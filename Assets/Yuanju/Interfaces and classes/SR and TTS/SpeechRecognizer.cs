...
public class SpeechRecognizer : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        actions.Add("Show inside", GameObject.Find("boiler and pins").GetComponent<Boiler>().ShowBoiler /*() => { Boiler.IsShowBoilerTriggered = true; }*/);
        actions.Add("Hide inside", GameObject.Find("boiler and pins").GetComponent<Boiler>().HideBoiler/*() => { Boiler.IsHideBoilerTriggered = true; }*/);

        actions.Add("Start animation", GameObject.Find("Managers").GetComponent<AnimationManager>().PlayAnimations/*() => { AnimationManager.IsStartAnimation = true; AnimationManager.isAnimationStateChanged = true; }*/);
        actions.Add("Stop animation", GameObject.Find("Managers").GetComponent<AnimationManager>().StopAnimations/*() => { AnimationManager.IsStartAnimation = false; AnimationManager.isAnimationStateChanged = true; }*/);
