...
public class PanelManager : MonoBehaviour
{
    ...
    void Awake()
    {
        listToggleText = new List<string>() //profile, mode and task
        {
            "Operator",/*Operator*/
            "Training",/*Training*/
            ""/*Activation*/
        }; 
        listToggleIson = new List<bool>() //is the toggle is selected
        {
            true,
            true,
            true
        }; 
        toggleTags = new List<string>() //the text on the task toggle
        {
            "User profile toggle",
            "Mode toggle",
            "Objective toggle"
        ...
        userProfileObjectives.Add("Operator", NPOIGetInitialFinalSettings.SubTasks);
    ...
    public void HideMenu() //subscribe to the confirm button
    {
        ...
        //Debug.Log("the panel is hidden here: " + menuLanguagesCanvasPanels[languageOption]);
        languagePanel.SetActive(false);
    }
